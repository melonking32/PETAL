...
from lavis.datasets.builders.vqa_builder import (
    ...
    VGVQABuilder,
    GQABuilder,
    AOKVQA_Instruct_Builder,
    OKVQA_Instruct_Builder,
    COCOVQA_Instruct_Builder,
)
from lavis.datasets.builders.add_dataset_builder import (
    AOKVQA_Question_Generate_Builder,
    OKVQA_Question_Generate_Builder,
    COCO_Question_Generate_Builder
)
