...
from lavis.datasets.datasets.coco_caption_datasets import (
    ...
    COCOCapEvalDataset,
    NoCapsEvalDataset,
    NoCapsEval_Instruct_Dataset,
)

from lavis.datasets.datasets.add_datasets import (
    LLaVADataset,
    TextCapsDataset,
    TextCaps_Eval_Dataset
)
...
class TextCapsBuilder(BaseDatasetBuilder):
    ...
    eval_dataset_cls = TextCaps_Eval_Dataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/textcaps/defaults.yaml",
    }

@registry.register_builder("llava-instruct")
...
class COCOCapBuilder(BaseDatasetBuilder):
    eval_dataset_cls = NoCapsEval_Instruct_Dataset
