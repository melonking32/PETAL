...
from lavis.datasets.datasets.gqa_datasets import GQADataset, GQAEvalDataset,GQA_Instruct_Dataset
...
class COCOVQA_Instruct_Builder(BaseDatasetBuilder):
    train_dataset_cls = COCOVQA_Instruct_Dataset
    eval_dataset_cls = COCOVQA_Instruct_EvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/coco/defaults_vqa_instruct.yaml",
        "eval": "configs/datasets/coco/eval_vqa_instruct.yaml",
    }
...
class OKVQA_Instruct_Builder(BaseDatasetBuilder):
    train_dataset_cls = OKVQA_Instruct_Dataset
    eval_dataset_cls = COCOVQAEvalDataset
    DATASET_CONFIG_DICT = {
...
class AOKVQA_Instruct_Builder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQA_Instruct_Dataset
...
class GQA_Instruct_Builder(BaseDatasetBuilder):
    train_dataset_cls = GQA_Instruct_Dataset
    eval_dataset_cls = GQAEvalDataset
