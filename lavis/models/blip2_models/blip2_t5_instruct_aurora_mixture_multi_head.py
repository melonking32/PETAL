...
@registry.register_model("blip2_t5_instruct_aurora_mixture_multi_head")
class Blip2T5InstructAurora_Mixture_Multi_Head(Blip2Aurora):
    """
    BLIP2 T5 model.
    ...
    def forward(self, samples):
        ...
        image = samples["image"]
        inputs_t5_1,atts_t5=self.get_query_embedding_1(samples['Instruct_1'],image)
        inputs_t5_2,_ =self.get_query_embedding_2(samples['Instruct_2'],image)
        inputs_t5_3,_ =self.get_query_embedding_3(samples['Instruct_3'],image)
