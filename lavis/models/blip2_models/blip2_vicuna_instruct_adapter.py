...
from lavis.models.blip2_models.blip2_adapter import Blip2Adapter, disabled_train

@registry.register_model("blip2_vicuna_instruct_adapter")
class Blip2VicunaInstruct_Adapter(Blip2Adapter):
    """
    BLIP2 Vicuna model.
