...
@registry.register_model("blip2_t5_instruct_aurora_information")
# class Blip2T5InstructAurora(Blip2Base):
class Blip2T5InstructAurora_Info(Blip2Aurora):
    """
    BLIP2 T5 model.
    ...
    def __init__(
        ...
        self.CP_U_Image = nn.Linear(1408, self.R, bias=False)
        self.CP_V_Image = nn.Linear(self.R, 768, bias=False)
    ...
    def forward(self, samples):
        ...
        with self.maybe_autocast(dtype=torch.bfloat16):
            ...
            # print(loss)
            # print(wrapper_loss)
            # return {"loss": loss+0.1*wrapper_loss}
